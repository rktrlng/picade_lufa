...
/** \file
 *  \brief Board specific information header for the Picade.
 *  \copydetails Group_BoardInfo_PICADE
 *
 ...
 *  \defgroup Group_BoardInfo_PICADE PICADE
 *  \brief Board specific information header for the Picade.
 *
 *  Board specific information header for the Picade.
 *
 *  @{
 */

#ifndef __BOARD_PICADE_H__
#define __BOARD_PICADE_H__
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Inline Functions: */
			...
			static inline void Picade_Init(void)
			{
				Joystick_Init();
				Buttons_Init();
				Util_Init();
